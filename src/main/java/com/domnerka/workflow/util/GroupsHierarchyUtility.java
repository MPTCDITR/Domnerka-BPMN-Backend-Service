package com.domnerka.workflow.util;
...
import static com.domnerka.workflow.contant.ApplicationConst.*;

/**
 * The type Groups hierarchy utility.
 */
@UtilityClass
public class GroupsHierarchyUtility {
    ...
    /**
     * Formats user group hierarchies into a structured array of position
     * identifiers.
     *
     * Takes a list of group strings, extracts and organizes group info by
     * predefined positions.
     * Returns an array mapping each user's groups to specific organizational roles.
     *
     * @param userGroupList List of group strings.
     * @return Array of formatted position-group identifiers.
     */
